...
if ($action === 'note') {
    ...
    switch ($method) {
                    ...
                    foreach ($data['services'] as $service) {
                        ...
                        if (isset($service['materials'])) {
                            foreach ($service['materials'] as $material) {
                                $baseUnit = isset($material['baseUnit']) ? $material['baseUnit'] : '';
        ...
        case 'PUT':
            ...
            try {
                if ($action === 'close') {
                    // Uzavřít návštěvu a odepsat materiály
                    ...
                    // Přidat nové služby a materiály
                    if (isset($data['services'])) {
                        foreach ($data['services'] as $service) {
                    ...
                    // Pouhé uložení návštěvy (bez odepsání materiálů)
